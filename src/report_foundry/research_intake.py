"""Strict research intake contract and EvidencePack normalization.
...
def research_intake_to_evidence_pack(intake: ResearchIntake, *, author: str = "Research Intake Author") -> EvidencePack:
